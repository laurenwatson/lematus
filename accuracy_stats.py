...
for lang in langs:
    ...
    with open("data/languages/"+lang+"-20-char-context/train-targets".format(model), "r") as t:
        with open("data/languages/"+lang+"-20-char-context/train-sources".format(model), "r") as s:
            for line in s:
    ...
    blah = 0.0
    with open("data/languages/"+lang+"-20-char-context/dev-sources".format(model,data_set), "r") as i:
        with open("data/languages/"+lang+"-20-char-context/dev-targets".format(model,data_set), "r") as o:
            with open("data/languages/"+lang+"-20-char-context/dev-hypothesis-base1".format(model,data_set), "r") as p:
                for line in i:
                    try:
...
print('correct amb', 'correct unseen', 'correct unam', 'total correct', 'total copied', 'unseen SHBC',
    'total SHBC', 'amb SHBC', 'unamb SHBC', 'unseen SHBC from incorrect', 'unseen should not HBC')
