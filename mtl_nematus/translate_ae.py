...
class Translator(object):
    ...
    def _start_worker(self, process_id):
        ...
        while True:
            ...
            output_item = self._translate(process_id, input_item, models, sess)[0]
            ae_output_item = self._translate(process_id, input_item, models, sess)[1]
    ...
    def _translate(self, process_id, input_item, models, sess):
        ...
        results = inference_ae.ae_beam_search(models, sess, x, x_mask, k)
        sample = results[0]
        ae_sample = results[1]

        return [sample, ae_sample]
