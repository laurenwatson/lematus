...
model_name = '20-char-context-ae100'
...
for lang in langs:
    ...
    with open("tiny_data/languages_10/"+lang+"-20-char-context/train-targets".format(model), "r") as t:
        with open("tiny_data/languages_10/"+lang+"-20-char-context/train-sources".format(model), "r") as s:
            for line in s:
    ...
    blah = 0.0
    with open("tiny_data/languages_10/"+lang+"-20-char-context/dev-sources".format(model,data_set), "r") as i:
        with open("tiny_data/languages_10/"+lang+"-20-char-context/dev-targets".format(model,data_set), "r") as o:
            with open("tiny_data/languages_10/"+lang+"-20-char-context/dev-hypothesis-ae1".format(model,data_set), "r") as p:
                for line in i:
                    try:
