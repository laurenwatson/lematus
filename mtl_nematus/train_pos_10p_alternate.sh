...
n_words_ae_trg=($(wc -l ${modeldir}/data/train-pos-targets.json))
...
CUDA_VISISBLE_DEVICES=0 python nmt.py \
  ...
  --datasets ${modeldir}/data/train-sources ${modeldir}/data/train-targets ${modeldir}/data/train-pos-targets \
  --valid_datasets ${modeldir}/data/dev-sources ${modeldir}/data/dev-targets ${modeldir}/data/dev-pos-targets \
  --dictionaries ${modeldir}/data/train-sources.json ${modeldir}/data/dev-targets.json ${modeldir}/data/dev-pos-targets.json \
  --dim_word ${dim_word} \
  --dim ${dim} \
