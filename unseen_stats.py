...
for lang in langs:
    ...
    with open("data/languages_10/"+lang+"-20-char-context/train-targets".format(model), "r") as t:
        with open("data/languages_10/"+lang+"-20-char-context/train-sources".format(model), "r") as s:
            for line in s:
